...
def main():
    ...
    # Removed: parser.add_argument("--project", default="atl-crime-hourly-forecast", help="Weights & Biases project name",)
...
# --- WANDB HARDCODED CONFIGURATION ---
    ...
    WANDB_RUN_NAME = "Multi_Horizon_XGB_Base"
    # --- END WANDB CONFIG ---

    print(f"Initial    izing wandb run: Project={WANDB_PROJECT_NAME}, Name={WANDB_RUN_NAME}")
