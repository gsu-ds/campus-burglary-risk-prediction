...
# Configs
from config import ARTIFACTS_DIR, PROCESSED_DIR, LEADERBOARD_DIR,TEST_RESULTS_DIR, WANDB_OUTPUT_DIR
# Data Panel Paths
...
# Result Paths
TEST_RESULTS_ROOT = TEST_RESULTS_DIR

OUT_DIR = TEST_RESULTS_DIR / "horizon_models"
...
# Save predictions to the official test_results directory
    ...
    out.to_csv(pred_dir / "hourly_npu_predictions_multi_horizon.csv", index=False)


    model_artifact_dir = ARTIFACTS_DIR / "horizon_models"
    model_artifact_dir.mkdir(parents=True, exist_ok=True)

    model_path = model_artifact_dir / "xgb_multioutput_hourly_npu_lite.joblib"
    meta_path  = model_artifact_dir / "meta_hourly_npu_lite.json"
